...
if ($package -notmatch "(?s)firmware_build.*switch1_pro_bridge_v5_9_18_test.*DeviceDefaultMode SWITCH1_PRO_MODE") {
    throw "package_v5_9_manager.ps1 does not lock the Switch 1 Pro profile."
}
