...
public static class OutputModeCatalog
{
    ...
    public static readonly OutputModeProfile Switch1Pro = new(
        "switch1_pro_bridge_v5_9_18_test",
        OutputModeId.Switch1Pro,
        "Switch 1 / Pro 有线转无线（测试）",
        "VID_057E&PID_2009",
        true,
        "真实 Pro2 通过 BLE 接入 ESP32-S3，再以 Switch 1 Pro Controller USB 身份连接初代 Switch。需在主机开启 Pro Controller Wired Communication；不支持 NFC。");
