...
$buildPath = Join-Path $repoRoot "build\pico2w-r3"
$releasePath = Join-Path $repoRoot "release\pico2w-pro2-wireless-test-r3"
...
try {
    ...
    $buildShort = "$drive\build\pico2w-r3"
...
$uf2Target = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r3.uf2"
$elfTarget = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r3.elf"
...
Write-Host ""
Write-Host "Pico 2 W r3 package ready:"
