...
$buildPath = Join-Path $repoRoot "build\pico2w-r4"
$releasePath = Join-Path $repoRoot "release\pico2w-pro2-wireless-test-r4"
...
try {
    ...
    $buildShort = "$drive\build\pico2w-r4"
...
$uf2Target = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r4.uf2"
$elfTarget = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r4.elf"
...
Write-Host ""
Write-Host "Pico 2 W r4 package ready:"
