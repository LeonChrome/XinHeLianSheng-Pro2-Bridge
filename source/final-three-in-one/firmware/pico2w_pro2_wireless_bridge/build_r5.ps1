...
$buildPath = Join-Path $repoRoot "build\pico2w-r5"
$releasePath = Join-Path $repoRoot "release\pico2w-pro2-wireless-test-r5"
...
try {
    ...
    $buildShort = "$drive\build\pico2w-r5"
...
$uf2Target = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r5.uf2"
$elfTarget = Join-Path $releasePath "XinHeLianSheng-Pico2W-Pro2-Wireless-Bridge-test-r5.elf"
...
Write-Host ""
Write-Host "Pico 2 W r5 package ready:"
